    ...
    public class LocalProceduralBiome : MonoBehaviour, IProceduralBiome, ISerializationCallbackReceiver
    {
        ...
        private IEnumerator RequestDataProgressive(BiomeDataRequest request, Bounds worldBounds, int heightMapResolution, int textureResolution)
        {
            ...
            if (cachedData == null)
            {
                ...
                CoroutineUtility.StartCoroutine(TerrainGraphUtilities.RequestBiomeData(cacheDataRequest, m_terrainGraph, biomeWorldBoundsInt, space, m_baseResolution, m_seed, inputContainer, m_dataMask, inputProvider.FillTerrainGraphArguments));
