...
namespace Pinwheel.Vista.Graph
{
    ...
    {
        public static IEnumerator RequestBiomeData(BiomeDataRequest request, TerrainGraph graph, Bounds biomeWorldBounds, Space simSpace, int baseResolution, int seed, GraphInputContainer inputContainer = null, BiomeDataMask dataMask = (BiomeDataMask)~0, TerrainGraph.FillArgumentsHandler fillArgumentsCallback = null)
        {
