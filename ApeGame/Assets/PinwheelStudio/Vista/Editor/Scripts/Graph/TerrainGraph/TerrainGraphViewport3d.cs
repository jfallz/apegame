...
namespace Pinwheel.VistaEditor.Graph
{
    public class TerrainGraphViewport3d : Viewport
    {
        ...
        private void RenderTerrain(Camera camera, int gridSize)
        {
            ...
            Matrix4x4 terrainToWorld = Matrix4x4.TRS(Vector3.zero, Quaternion.Euler(m_modelRotation), new Vector3(1, 1, 1));
        ...
        {
            m_cameraPosition = new Vector3(-500, 500, -500);
            m_cameraRotation = new Vector3(15, 45, 0);
            RenderViewport();
            MarkDirtyRepaint();
        }
