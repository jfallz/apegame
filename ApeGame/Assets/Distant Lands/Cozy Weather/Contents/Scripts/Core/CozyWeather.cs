...
namespace DistantLands.Cozy
{
    ...
    public class CozyWeather : CozyEcosystem
    {
        ...
        public MeridiemTime currentTime
        {
            ...
            set
            {
                ...
                if (timeControl == TimeControl.native)
                {
                    calendar.currentTicks = MeridiemTime.MeridiemTimeToDayPercent(value);
                }
                else
                {
                    perennialProfile.currentTicks = MeridiemTime.MeridiemTimeToDayPercent(value);
                }
    ...
    public class MeridiemTime
    {
        ...
        public static float MeridiemTimeToDayPercent(MeridiemTime time)
        {
            ...
            return (((float)time.hours + (float)time.minutes / 60) / 24) + (time.meridiem == Meridiem.PM ? 0.5f : 0);
